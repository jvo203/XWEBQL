...
const parallel_bayesian_binning_fptr = Libc.Libdl.dlsym(lib, "parallel_bayesian_binning")
const fast_bayesian_binning_energy_range_fptr = Libc.Libdl.dlsym(lib, "fast_bayesian_binning_energy_range")
